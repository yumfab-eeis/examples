...
class NoiseGenetator(nn.Module):
    def __init__(self, block, nblocks, nchannels, nfilters, nclasses):
        ...
        self.layer4 = self._make_layer(block, 4*nfilters, 4*nfilters, nblocks[3], level=0.4)
        self.layer5 = self._make_layer(block, 4*nfilters, nchannels, nblocks[4], level=0.8)
