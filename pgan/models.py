...
class NoiseGenetator(nn.Module):
    def __init__(self, block, nblocks, nchannels, nfilters, nclasses, level):
        ...
        self.layer1 = self._make_layer(block, 8*nfilters, 64*nfilters, nblocks[0], level=level)
        ...
        self.layer4 = self._make_layer(block, 16*nfilters, 4*nfilters, nblocks[3], level=level)
