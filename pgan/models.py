...
class NoiseResGenetator(nn.Module):
    def __init__(self, block, nblocks, nchannels, nfilters, nclasses, level):
        ...
        self.layer1 = self._make_layer(block, 8*nfilters, 128*nfilters, nblocks[0], level=level)
        self.layer2 = self._make_layer(block, 128*nfilters, 16*nfilters, nblocks[1], level=level)
