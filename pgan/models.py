...
class NoiseGenetator(nn.Module):
    def __init__(self, block, nblocks, nchannels, nfilters, nclasses):
        ...
        self.layer3 = self._make_layer(block, 8*nfilters, 8*nfilters, nblocks[2], level=0.4)
        self.layer4 = self._make_layer(block, 8*nfilters, 8*nfilters, nblocks[3], level=0.8)
        self.layer5 = self._make_layer(block, 8*nfilters, nchannels, nblocks[4], level=0.8)
