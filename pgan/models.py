...
def noiseresgenerator101(nchannels, nfilters, nclasses, level=1):
    return NoiseResGenetator(NoiseNoPoolBlock, [3,3,3,3,3,10,10], nchannels=nchannels, nfilters=nfilters, nclasses=nclasses, level=level)
